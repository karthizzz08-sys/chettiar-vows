...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Trusted Tamil Chettiar matrimony with verified profiles, traditional values, and modern matchmaking." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#8b1a1a" },
      { name: "twitter:title", content: "Chettiar Connect — Tamil Chettiar Matrimony" },
      { name: "twitter:description", content: "Trusted Tamil Chettiar matrimony with verified profiles, traditional values, and modern matchmaking." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/cd1b6c1b-3bae-46ea-9aca-48875f74cecf/id-preview-b164bd23--4d1fade9-fae2-432d-a675-ce9b20525fbc.lovable.app-1779437946172.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/cd1b6c1b-3bae-46ea-9aca-48875f74cecf/id-preview-b164bd23--4d1fade9-fae2-432d-a675-ce9b20525fbc.lovable.app-1779437946172.png" },
    ],
    links: [
